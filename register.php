			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner register_form_inner">
						...
						<form class="row login_form" action="register_code.php" id="register_form" method="post" >
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="phno" name="Ph_no" placeholder="Phone No." onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone No.'" required>
							</div>
							<div class="col-md-12 form-group">
              ...
              <div class="col-md-12 form-group">
								<input type="password" class="form-control" id="confirmPassword" name="Re_Password" placeholder="Confirm Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Confirm Password'" required>
							</div>
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="button button-register w-100" name="ok">Register</button>
							</div>
						</form>
					</div>
				</div>
